...
def about_us():
    tkinter.messagebox.showinfo('About Music', 'This is a music player build using Python Tkinter by me.')
...
root.iconbitmap(r'icon/music.ico')
...
stopPhoto = PhotoImage(file='icon/stop.png')
...
rewindPhoto = PhotoImage(file='icon/rewind.png')
rewindBtn = ttk.Button(bottomframe, image=rewindPhoto, command=rewind_music)
rewindBtn.grid(row=0, column=0)

mutePhoto = PhotoImage(file='icon/mute.png')
volumePhoto = PhotoImage(file='icon/volume.png')
